 ...
 <!-- Alerta de confirmación personalizada -->
   ...
   <div>
     <v-alert
      ...
      border="top"
    >
     <b>   Listado de Ingreso de Medicamentos  </b> 
...
exportToExcel() {
   ...
   async fetchArticulosMed() {
     ...
     async GenerarInforme() {
      ...
      const respuesta = await this.axios.get(`/api/ConfigForm/ObtenerEconoomatoFiltradosInfo?pFechaDesde=${fechaDesdeSinGuiones}&pFechaHasta=${fechaHastaSinGuiones}&Usuario=${this.idUsuario}&pInstitucion=${IdTipo}`)
