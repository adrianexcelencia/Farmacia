 ...
 <!-- Alerta de confirmación personalizada -->
   ...
   <div>
     <v-alert
      ...
      border="top"
    >
     <b>   Listado de deudas de medicamentos y descartables  </b> 
...
tempDiv.appendChild(createTitleWithImage(
  "Listado de Deuda de Medicamentos y Descartables", // Título
   ...
   async fetchArticulosMed() {
     ...
     async GenerarInforme() {
      ...
      // alert("ACA estoy");
         ...
         const respuesta = await this.axios.get(`/api/ConfigForm/ListarDeudaGeneral?pInstitucion=${IdTipo}&desde=${fechaDesdeSinGuiones}&hasta=${fechaHastaSinGuiones}pInstitucion=${IdTipo}`)
           .then((respuesta) => {
             //this.ListaFormulariosArticulos = respuesta.data.lista
             this.rows = respuesta.data.lista;
             let data = []; //declarar la variable data
